...
<section class="content-block">
  ...
  <p>
    Across major social welfare programs, the state government provides enhanced financial assistance to women belonging to Scheduled Caste (SC) and Scheduled Tribe (ST) communities. For example, under Lakshmir Bhandar, SC/ST women received ₹1,700 monthly compared to ₹1,500 for general category recipients previously (now flat ₹3,000/month under Annapurna Bhandar), while scholarship allocations under Shikshashree and Oasis guarantee 100% coverage for eligible SC/ST female applicants.
  </p>
</section>
`;
